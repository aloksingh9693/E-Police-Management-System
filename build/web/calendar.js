...
/////////////////////////////////////My generated code //////////////////////////////
function showDistrict(std_value)
{
    if(std_value!="-1")
	{
...
document.form1.menu_thana.options.length=0;
                     for (var i=0; i < strar.length;++i){
                         var str=strar[i].split("*");
                         addOption(document.form1.menu_thana, str[1], str[0]);
...
function vald_sdf(){
    ...
    if(document.form1.datum1.value=="")
{
    alert("fill the date:-");
    return false;
}
...
if(document.form1.AMOUNT.value="" ){
    alert("amount must be more than 4000");
    return false;
